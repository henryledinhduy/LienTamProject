# Generated by Django 2.0.3 on 2018-03-10 19:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.CharField(default='null', max_length=50)),
                ('social_number', models.CharField(max_length=14, unique=True)),
                ('phap_danh', models.CharField(blank=True, max_length=20, null=True)),
                ('nationality', models.CharField(default='null', max_length=20)),
        ...
        migrations.AddField(
            model_name='setting',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='membership.UserProfile'),
        ),
        migrations.AddField(
            model_name='donation',
            name='person',
